...
const HeroSection = () => {
  return (
    <div className="scroll-mt-[1000px]" id="home">
      <HeroAnimationProvider>
        <section className="flex flex-col items-center mt-[120px] scroll-mt-[2000px]">
          <Badge
            className={cn(
          ...
          <div className="text-[16px] tracking-tight mt-3 flex flex-col items-center">
            <p className={cn("", raleway.className)}>
              Never face the blank page alone again. Article Pal is your trusty
              AI sidekick, generating multiple high-quality
            </p>
            <p className={cn("", raleway.className)}>

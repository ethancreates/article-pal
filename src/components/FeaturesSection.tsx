      ...
      <div className="flex flex-col items-center pt-20">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-center text-[16px]">
            <p>
              These are the most helpful features offered to help writers create
              meaningful articles and
            </p>
        ...
        <div className="mt-32 flex flex-col items-center">
          ...
          <div className="flex w-[900px] flex-row space-x-2">
            ...
            <div className="flex h-[300px] w-[600px] basis-2/3 flex-col rounded-2xl bg-background p-8 text-foreground">
              ...
              <p className="mt-2">Claude and Gemini support to follow soon!</p>
            </div>
          </div>
          {/* Second Row */}
          <div className="mt-4 flex w-[900px] flex-row space-x-2">
            ...
            <div className="flex h-[300px] w-[300px] basis-1/3 flex-col rounded-2xl bg-background p-8 text-foreground">
              ...
              <p className="mt-2 font-light leading-tight">
                ...
                can decide if Article Pal intelligently chooses your outline for
                you or you dissect and choose your own subheadings.
              </p>
            </div>
            {/* Factual Information */}
            <div className="flex h-[300px] w-[300px] basis-1/3 flex-col rounded-2xl bg-background p-8 text-foreground">
              ...
              <p className="mt-2 font-light leading-tight">
                ...
                talking point text area to ensure that Article Pal has the right
                facts when writing the article.
              </p>
            </div>
            {/* Factual Information */}
            <div className="flex h-[300px] w-[300px] basis-1/3 flex-col rounded-2xl bg-background p-8 text-foreground">
              ...
              <p className="mt-2 font-light leading-tight">
                Article Pal allows you to generate great keywords with the title
                as reference, it uses an advance algorithm to suggest better
                keywords or you can also manually add your own keywords for the
                added flexibility.
              </p>
            </div>
          </div>

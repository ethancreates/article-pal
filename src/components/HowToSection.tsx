          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center mt-5">
              ...
              <p className={raleway.className}>
                ...
                &quot;Informative&quot;, &quot;Professional&quot;, and many
                more.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-between w-[900px]">
          ...
          <div className="mt-[120px] flex">
            ...
            <div className="space-y-7 ml-16">
              ...
              >
                After providing Article Pal a title and optionally some
                keywords, it will ask you if you would want to have the outline
                gerated for you or if you want to manually fill the outline with
                your own crafted outline.
              </p>
            </div>
          </div>
          {/* bottom side */}
          <div className="flex flex-col">
            <div className="flex items-center mt-10">
              <IoIosCheckbox className="text-3xl mr-2" />
              <p className={raleway.className}>
                Consider adding facts within the talking points to further
                improve the quality, as well as ensure that all information
                generated will be factual always.
              </p>
            </div>
            <div className="flex items-center mt-5">
              ...
              <p className={raleway.className}>
                ...
                (MECE) Framework. This is to ensure comprehensive coverage of
